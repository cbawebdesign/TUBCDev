...
export default function UploadPage() {
  ...
  const categories = ['TEST','MASTER_SHEET','PAYFILE_RAW', 'PAYFILE_EXTRACTED', 'MISMATCHED_PREMIUMS', 'USERS_NOT_IN_DATABASE', 'PREMIUM_HISTORY_ALL', 'PREMIUM_MISMATCHES_ALL', 'DEDUCTION_STATUS_CHANGES', 'MASTER_SHEET_CHANGES','PastPayFile','SENT_NY_FILES', 'ACTIVE_USERS_MISSING'];
