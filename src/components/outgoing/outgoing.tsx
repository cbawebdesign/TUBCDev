...
<button onClick={deleteSelectedLines} style={{ backgroundColor: '#f44336', color: 'white', border: 'none', borderRadius: '4px', padding: '10px 20px', fontSize: '16px', cursor: 'pointer' }}>Delete Selected</button>    
  ...
  <pre>
  {`
1338072     F459270013380720000002024-08-158271A2024-08-15605BM68419999-12-310000000002839
1742858     F459270017428580000002024-08-158271A2024-08-15605BM68419999-12-310000000004362
