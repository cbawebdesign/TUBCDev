...
<button onClick={deleteSelectedLines} style={{ backgroundColor: '#f44336', color: 'white', border: 'none', borderRadius: '4px', padding: '10px 20px', fontSize: '16px', cursor: 'pointer' }}>Delete Selected</button>    
  ...
  <pre>
  {`
1107170     F459270011071700000002024-09-038271C2024-09-03605BM68419999-12-310000000001925

1127067     F459270011270670000002024-09-038271C2024-09-03605BM68419999-12-310000000000000

1338072     F459270013380720000002024-09-038271C2024-09-03605BM68419999-12-310000000002839

1844985     F459270018449850000002024-09-038271A2024-09-03605BM68419999-12-310000000002565
`}
 </pre>
