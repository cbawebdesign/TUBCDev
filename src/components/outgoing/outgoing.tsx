...
<button onClick={deleteSelectedLines} style={{ backgroundColor: '#f44336', color: 'white', border: 'none', borderRadius: '4px', padding: '10px 20px', fontSize: '16px', cursor: 'pointer' }}>Delete Selected</button>    
  ...
  1127067     F459270011270670000002024-05-018271C2024-05-01605BM68419999-12-3100000000006929

1142873     F459270011428730000002024-05-018271C2024-05-01605BM68419999-12-3100000000003566

1478869     F459270014788690000002024-05-018271C2024-05-01605BM68419999-12-3100000000002181
