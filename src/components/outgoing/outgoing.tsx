...
<button onClick={deleteSelectedLines} style={{ backgroundColor: '#f44336', color: 'white', border: 'none', borderRadius: '4px', padding: '10px 20px', fontSize: '16px', cursor: 'pointer' }}>Delete Selected</button>    
  ...
  <pre>
  {`
1632133     F459270016321330000002024-10-248271C2024-10-24605BM68412024-10-230000000000000
1929379     F459270019293790000002024-10-248271C2024-10-24605BM68419999-12-310000000005816
`}
 </pre>
