...
<button onClick={deleteSelectedLines} style={{ backgroundColor: '#f44336', color: 'white', border: 'none', borderRadius: '4px', padding: '10px 20px', fontSize: '16px', cursor: 'pointer' }}>Delete Selected</button>    
  ...
  <pre>
  {`
0532140     F459270005321400000002025-11-068271C2025-11-06605BM68412025-11-050000000000000

0851002     F459270008510020000002025-11-068271C2025-11-06605BM68419999-12-310000000006693

1434034     F459270014340340000002025-11-068271A2025-11-06605BM68419999-12-310000000003959

1700882     F459270017008820000002025-11-068271C2025-11-06605BM68419999-12-310000000005146
`}
 </pre>
